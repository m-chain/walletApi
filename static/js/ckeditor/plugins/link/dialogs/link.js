    ...
    function(g) {
        ...
        return {
                ...
                },
                {
                    ...
                    children: [{
                        ...
                        },
                        {
                            ...
                            validate: function() {
                                var a = this.getDialog();
                                return a.getContentElement("info", "linkType") && "url" != a.getValueOf("info", "linkType") ? !0 : /javascript\:/.test(this.getValue()) ? (alert(c.invalidValue), !1) : this.getDialog().fakeObj ? !0 : CKEDITOR.dialog.validate.notEmpty(b.noUrl).apply(this)
                            },
                            setup: function(a) {
                                this.allowOnChange = !1;
                        ...
                        children: [{
                            ...
                            children: [{
                                ...
                                setup: function(a) {
                                    this.clear();
                                    this.add("");
                                    if (a.anchors) for (var b = 0; b < a.anchors.length; b++) a.anchors[b].name && this.add(a.anchors[b].name);
            ...
            onShow: function() {
                ...
                b = a.getSelection(),
                c = null; (c = k.getSelectedLink(a)) && c.hasAttribute("href") ? b.getSelectedElement() || b.selectElement(c) : c = null;
            ...
            onOk: function() {
                ...
                c = k.getLinkAttributes(g, a);
                if (this._.selectedElement) {
                    var d = this._.selectedElement,
                    f = d.data("cke-saved-href"),
                    e = d.getHtml();
                    d.setAttributes(c.set);
                    d.removeAttributes(c.removed);
                    if (f == e || "email" == a.type && -1 != e.indexOf("@")) d.setHtml("email" == a.type ? a.email.address: c.set["data-cke-saved-href"]),
                    b.selectElement(d);
